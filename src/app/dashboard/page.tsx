            ...
            <table className="data-table">
              ...
              <tbody>
                {Object.keys(lastParam.params.cloroLibre).map(pool => {
                  const cl = lastParam.params.cloroLibre[pool as any];
                  const cc = lastParam.params.cloroCombinado[pool as any];
                  const ph = lastParam.params.ph[pool as any];
                  const temp = lastParam.params.temperatura[pool as any];
